...
< a href = " foo " > as "foo"* /
	...
	void map_html_tags(HTTPCSTR, int, void(*)(struct taginfo*, void *,
	HTTPCHAR*, HTTPCHAR*, struct httpdata*), void *, int,
	const struct hash_table*, const struct hash_table*, HTTPCHAR*, HTTPCHAR*,
	httpdata*);
