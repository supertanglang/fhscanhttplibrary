...
#define zlib_version zlibVersion()
	...
	ZEXTERN int ZEXPORT deflateParams OF((z_streamp strm, int level,
		int strategy));
	/*
	...
	ZEXTERN int ZEXPORT deflateTune OF((z_streamp strm, int good_length,
	...
	ZEXTERN int ZEXPORT inflateSetDictionary OF
		((z_streamp strm, const Bytef *dictionary, uInt dictLength));
	/*
	...
	ZEXTERN int ZEXPORT inflateBack OF((z_streamp strm, in_func in,
	...
	ZEXTERN z_off_t ZEXPORT gzseek OF((gzFile file, z_off_t offset,
		int whence));
	/*
	...
	ZEXTERN uLong ZEXPORT crc32_combine OF((uLong crc1, uLong crc2,
		z_off_t len2));
	...
	ZEXTERN int ZEXPORT inflateInit_ OF((z_streamp strm, HTTPCSTR version,
		int stream_size));
	ZEXTERN int ZEXPORT deflateInit2_ OF((z_streamp strm, int level, int method,
		int windowBits, int memLevel, int strategy, HTTPCSTR version,
		int stream_size));
	ZEXTERN int ZEXPORT inflateInit2_ OF((z_streamp strm, int windowBits,
		HTTPCSTR version, int stream_size));
	ZEXTERN int ZEXPORT inflateBackInit_ OF((z_streamp strm, int windowBits,
		unsigned char FAR *window, HTTPCSTR version, int stream_size));
